...
#define ZH_TITLE "\xE6\xB8\xA9\xE5\xBA\xA6\xE6\xB5\x8B\xE9\x87\x8F"
...
#define ZH_PAGE1 "\xE7\xAC\xAC""1""\xE9\xA1\xB5\xE6\xB8\xA9\xE5\xBA\xA6\xE6\xB5\x8B\xE9\x87\x8F\xE9\xA1\xB9\xE5\x8D\xA0\xE4\xBD\x8D"
#define ZH_PAGE2 "\xE7\xAC\xAC""2""\xE9\xA1\xB5\xE6\xB8\xA9\xE5\xBA\xA6\xE6\xB5\x8B\xE9\x87\x8F\xE9\xA1\xB9\xE5\x8D\xA0\xE4\xBD\x8D"
#define ZH_PAGE3 "\xE7\xAC\xAC""3""\xE9\xA1\xB5\xE6\xB8\xA9\xE5\xBA\xA6\xE6\xB5\x8B\xE9\x87\x8F\xE9\xA1\xB9\xE5\x8D\xA0\xE4\xBD\x8D"
...
static temperature_state_t g_state;

static const temperature_page_t temperature_pages[] = {
    {ZH_PAGE1, "Temperature measurement page 1 placeholder"},
    {ZH_PAGE2, "Temperature measurement page 2 placeholder"},
    {ZH_PAGE3, "Temperature measurement page 3 placeholder"},
};
...
static lv_obj_t *create_indicator(lv_obj_t *parent)
{
    ...
    for(uint32_t i = 0; i < 3; i++) {
        ...
        lv_obj_set_style_bg_color(dot, i == 0 ? lv_color_hex(0xDC2626) : lv_color_hex(0xCBD5E1), 0);
...
static void update_indicator(lv_obj_t *indicator, uint32_t active_index)
{
    for(uint32_t i = 0; i < lv_obj_get_child_count(indicator); i++) {
        ...
        lv_obj_set_style_bg_color(dot, active ? lv_color_hex(0xDC2626) : lv_color_hex(0xCBD5E1), 0);
    }
}
...
static lv_obj_t *create_menu_btn(lv_obj_t *parent, const char *text, lv_color_t pressed_color, lv_event_cb_t cb)
{
    ...
    lv_obj_set_style_border_color(btn, lv_color_hex(0xFCA5A5), LV_STATE_PRESSED);
...
static void create_bottom_bar(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_bg_color(bar, lv_color_hex(0xFEF2F2), 0);
    lv_obj_set_style_bg_opa(bar, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(bar, 1, 0);
    lv_obj_set_style_border_color(bar, lv_color_hex(0xF3D0D0), 0);
    ...
    start_btn = create_menu_btn(bar, "", lv_color_hex(0xFECACA), start_stop_event);
    ...
    create_menu_btn(bar, ui_lang(ZH_SAVE, "Save"), lv_color_hex(0xFECACA), empty_event);
    create_menu_btn(bar, ui_lang(ZH_PRINT, "Print"), lv_color_hex(0xFECACA), empty_event);
}

static void create_page_card(lv_obj_t *parent, const temperature_page_t *page)
{
    ...
    lv_obj_set_style_border_color(card, lv_color_hex(0xF1D4D4), 0);
    lv_obj_set_style_shadow_width(card, 8, 0);
    lv_obj_set_style_shadow_opa(card, LV_OPA_10, 0);
    lv_obj_set_style_shadow_color(card, lv_color_hex(0xFCA5A5), 0);
    ...
    lv_obj_set_style_bg_color(box, lv_color_hex(0xFFF7F7), 0);
    lv_obj_set_style_bg_opa(box, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(box, 2, 0);
    lv_obj_set_style_border_color(box, lv_color_hex(0xF0CACA), 0);
...
static void create_tileview(lv_obj_t *parent, lv_obj_t *indicator)
{
    ...
    for(uint32_t i = 0; i < 3; i++) {
        ...
        create_page_card(tile, &temperature_pages[i]);
    }
}
...
lv_obj_t *ui_temperature_create(void)
{
    ...
    create_title(screen, ui_lang(ZH_TITLE, "Temperature"));
